...
public class RepeatedInDomainSingleFold implements Constants {
    ...
    public static void main(String[] args) throws Exception {
        ...
        RepeatedInDomainSingleFold experiment = new RepeatedInDomainSingleFold();
...
//        ExperimentUtils.evaluate(args[2], 2);
	...
	protected void run(ParameterSpace pSpace, String foldFile, boolean useDevSet, int foldID) throws Exception {
		ExperimentSingleFold batch = new ExperimentSingleFold("ClaimDetection", WekaClassificationAdapter.class, getPreprocessing(), foldFile, useDevSet, foldID);
