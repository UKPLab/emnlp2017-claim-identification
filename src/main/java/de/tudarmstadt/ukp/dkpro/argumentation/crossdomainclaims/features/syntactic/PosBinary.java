 ...
 */
public class PosBinary extends FeatureExtractorResource_ImplBase implements ClassificationUnitFeatureExtractor {

	public static final String FN_POS_DIST = "POS_BIN_";
...
//        Collection<Token> tokens = FeatureUtils.getComponentAndPrecedingTokens(jcas, classificationUnit);
        ...
        for (String pos : map.keySet()) {
        	featureList.add(new Feature(FN_POS_DIST+pos, (map.get(pos).intValue()>0?1:0)));
        }
