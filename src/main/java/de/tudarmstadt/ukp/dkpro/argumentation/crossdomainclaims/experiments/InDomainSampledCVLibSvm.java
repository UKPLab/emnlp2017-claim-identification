...
/**
 * Performs default 10-fold cross-validation on a class-balanced dataset
 * Experiments with the same random seed are reproducible.
 *  
 */
public class InDomainSampledCVLibSvm implements Constants {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ParameterSpace pSpace = getParameterSpace(features, args[0], args[4], args[1]);
        InDomainSampledCVLibSvm experiment = new InDomainSampledCVLibSvm();
		...
		System.out.println("Total_time_in_minutes " + TimeUnit.MILLISECONDS.toMinutes(totalTime));
    }
	
	
	@SuppressWarnings("unchecked")
	public static ParameterSpace getParameterSpace(List<String> featureType, String corpusPath, String languageCode, String randomSeed) throws IOException {
        ...
        ParameterSpace pSpace = new ParameterSpace(Dimension.createBundle("readers", dimReaders),
            ...
            Dimension.create("balanceRandomSeed", randomSeed) 
        );
        return pSpace;
	}
	...
	protected void run(ParameterSpace pSpace) throws Exception {
		ExperimentCrossValidation batch = new ExperimentCrossValidation("ClaimDetection", LiblinearAdapter.class, getPreprocessing(), 10);
