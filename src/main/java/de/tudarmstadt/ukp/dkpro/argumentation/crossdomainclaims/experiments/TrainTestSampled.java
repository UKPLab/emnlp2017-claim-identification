...
public class TrainTestSampled implements Constants {
	
	// 0 = full path to train data
	// 1 = full path to test data
	// 2 = random seed training data
	// 3 = full path to result folder (= DKPRO_HOME)
	// 4 = feature type (lexical, syntax, structure, embeddings, dictionary, discourse, sentiment) - combine with "-", e.g. lexical-syntax
	// 5 = language code train data
	// 6 = language code test data
    public static void main(String[] args) throws Exception {
  
//      	args = new String[6];
//    	args[0]="/Users/zemes/Desktop/NLP/Papers/TACL2016/data/prep4/PE";
//    	args[1]="/Users/zemes/Desktop/NLP/Papers/TACL2016/data/prep4/WD";
//    	args[1]="/Users/zemes/Desktop/NLP/Papers/TACL2016/data/prep4/MT";
//    	args[1]="/Users/zemes/Desktop/NLP/Papers/TACL2016/data/prep4/OC";
//    	args[1]="/Users/zemes/Desktop/NLP/Papers/TACL2016/data/prep4/WTP";
    	//args[1]="/Users/zemes/Desktop/NLP/Papers/TACL2016/data/prep4/VG";
//    	args[1]="/Users/zemes/Desktop/NLP/Papers/TACL2016/data/prep4/PE";
//    	args[2]="/Users/zemes/DEVELOPMENT/Experiments/Cross-Domain-Experiments/structure2/PE-MT-structure";
//    	args[3]="structure";
//    	args[4]="en";
//    	args[5]="en";
	    ...
	    System.setProperty("DKPRO_HOME", args[3]);
		long startTime = System.currentTimeMillis();
    	
		List<String> features = new ArrayList<String>(Arrays.asList(args[4].split("-")));
        ParameterSpace pSpace = getParameterSpace(features, args[0], args[1], args[5], args[6], args[2]);
        TrainTestSampled experiment = new TrainTestSampled();
        
        experiment.run(pSpace);
        ExperimentUtils.evaluate(args[3], 2);
	...
	public static ParameterSpace getParameterSpace(List<String> featureType, String corpusPathTrain, String corpusPathTest, 
        ...
        dimReaders.put(DIM_READER_TRAIN_PARAMS, Arrays.asList(
        		RandomBalancedCorpusSampler.PARAM_SOURCE_LOCATION, corpusPathTrain,
        		...
        		RandomBalancedCorpusSampler.PARAM_PATTERNS, Arrays.asList(RandomBalancedCorpusSampler.INCLUDE_PREFIX + "*.xmi")));
        // TEST
