...
import de.tudarmstadt.ukp.dkpro.tc.ml.ExperimentSingleFold;
...
public class RepeatedInDomainSingleFoldLibSvm implements Constants {
    ...
    public static void main(String[] args) throws Exception {
        ...
        RepeatedInDomainSingleFoldLibSvm experiment = new RepeatedInDomainSingleFoldLibSvm();
        
        experiment.run(pSpace, args[1], Boolean.parseBoolean(args[4]), Integer.parseInt(args[6]));
	...
	protected void run(ParameterSpace pSpace, String foldFile, boolean useDevSet, int foldID) throws Exception {
		ExperimentSingleFold batch = new ExperimentSingleFold("ClaimDetection", LiblinearAdapter.class, getPreprocessing(), foldFile, useDevSet, foldID);
