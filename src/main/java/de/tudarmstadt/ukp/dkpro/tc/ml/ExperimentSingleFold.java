...
import de.tudarmstadt.ukp.dkpro.tc.core.io.CustomFoldDimensionBundle2;
...
public class ExperimentSingleFold extends BatchTask {
     ...
     */
	public ExperimentSingleFold(String aExperimentName, Class<? extends TCMachineLearningAdapter> mlAdapter, AnalysisEngineDescription preprocessing, String aFoldFile, boolean useDevSet, int foldID) throws TextClassificationException {
		foldFile = aFoldFile;
...
//        }
    ...
    protected FoldDimensionBundle<String> getFoldDim(String[] fileNames) {
        return new CustomFoldDimensionBundle2("files", Dimension.create("", fileNames), foldFile, useDevSet, foldID);
    }
