...
class MLPDropout(object):
    ...
    def __init__(self,rng,input,layer_sizes,dropout_rates,activations,use_bias=True):
        ...
        self.errors2 = self.layers[-1].errors2
	self.errorsF1 = self.layers[-1].errorsF1
...
class MLP(object):
    ...
    def __init__(self, rng, input, n_in, n_hidden, n_out):
        ...
        self.errors2 =  self.logRegressionLayer.errors2
	self.errorsF1 = self.logRegressionLayer.errorsF1
...
class LogisticRegression(object):
    ...
    """
	    ...
	    recall_0 = true_pos_0 *1.0/ T.maximum(1.0,(true_pos_0 + false_neg_0))
	    prec_0 = true_pos_0 *1.0/ T.maximum(1.0,(true_pos_0 + false_pos_0))

	    f1 = (2. * prec_0 * recall_0 / T.maximum(1., prec_0 + recall_0))
    ...
    def errors2(self, y): # this is VERY stupid, SE
        """Return a float representing the number of errors in the minibatch ;
    zero one loss over the size of the minibatch
